...
Чтобы обеспечить дешевое повторное использование, тайлы не хранятся непосредственно в tilemap; вместо этого на тайлы ссылается *ID*, который вы можете увидеть в VRAM viewerе BGB.
...
Действительно, BGB сообщает, что первые 128 тайлов имеют те же ID, что и последние 128.
...
Теперь, пожалуйста, обратите свое внимание на вкладку "BG map" VRAM viewer BGB, изображенную ниже.
...
Таким образом, тайлы часто концептуально группируются в три "блока" по 128 тайлов в каждом, которые BGB показывает разделенными более толстыми горизонтальными линиями.