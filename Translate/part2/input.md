...
На данный момент игра играет в саму себя, давайте что-то с этим сделаем.
...
В данном контексте _инициализация_ и _задание нулевого значения_ - одно и то же. _Прим. переводчиков_
...
В коде ниже мы используем `and` (побитовое И), который нужен для того, чтобы устанавливать флаг `z`, когда не нажата необходимая кнопка.
