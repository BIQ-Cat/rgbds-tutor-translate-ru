...
Если `make` не найден, возможно вам потребуется установить его с помощью пакетного менеджера вашего дистрибутива.

### Windows

Утилиты, которые мы будем использовать, разработаны для Unix-подобных систем, установка инструментария для разработки под Game Boy сложнее, чем на Linux и macOS.
