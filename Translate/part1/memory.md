...
Что ж, вот memory map [в документации](https://gbdev.io/pandocs/Memory_Map.html) (я немного упрощу):
...
$C000 | $DFFF | WRAM | Рабочий RAM, оперативная память общего назначения для хранения игровых сущностей.
...
Если вы знакомы с C, то эти скобки в основном представляют собой способ реализации разыменования указателя.
...
[^rom_ram_and]:
Существуют и другие типы памяти, такие как флэш-память или EEPROM, но в Game Boy использовалась только Flash и только для нескольких игр; поэтому мы в целом можем  забыть о них.
